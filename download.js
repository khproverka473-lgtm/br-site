...
//
// Принимает ссылку на видео TikTok (?url=...) и возвращает прямую ссылку
// на файл без водяного знака, используя открытый сервис tikwm.com.
//
// ВАЖНО: tikwm.com — сторонний бесплатный сервис, не связанный с TikTok.
// Если TikTok изменит свой внутренний API, этот сервис (и, соответственно,
// эта функция) может временно перестать работать — тогда нужно будет
...
exports.handler = async function (event) {
  ...
  try {
    ...
    // play/hdplay иногда приходят относительными путями — на всякий случай
